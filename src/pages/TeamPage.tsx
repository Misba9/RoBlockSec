          ...
          <div className="mb-20">
            ...
            >
              {DEMO_TEAM.filter(m => m.category === 'founding').map((member, index) => (
                ...
                >
                  <div className="w-full h-80 bg-gradient-to-br from-brand-navy2 to-brand-dark flex items-center justify-center overflow-hidden">
                    {member.image ? (
          ...
          <div>
            ...
            >
              {DEMO_TEAM.filter(m => m.category === 'vanguard').map((member, index) => (
                ...
                >
                  <div className="w-full h-72 bg-gradient-to-br from-brand-navy2 to-brand-dark flex items-center justify-center overflow-hidden">
                    {member.image ? (
                      <img src={member.image} alt={member.name} className="w-full h-full object-cover" />
                    ) : (
                      <div className="w-full h-full bg-gradient-to-br from-brand-navy2 to-brand-dark flex flex-col items-center justify-center relative">
